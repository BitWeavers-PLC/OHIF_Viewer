  ...
  dataSources: [
    {
      ...
      configuration: {
        ...
        name: 'DCM4CHEE',
        wadoUriRoot: 'http://localhost/pacs/data/dicom-web',
        qidoRoot: 'http://localhost/pacs/data/dicom-web',
        wadoRoot: 'http://localhost/pacs/data/dicom-web',
